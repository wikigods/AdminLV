...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ?
    ...
    (typeof define === 'function' && define.amd ?
      ...
      (global = typeof globalThis === 'undefined' ? global || globalThis : globalThis, factory(global.adminlte = {}, global.jQuery)))
  ...
  var ControlSidebar = /*#__PURE__*/function () {
    ...
    _proto._init = function _init() {
      ...
      $__default["default"](globalThis).resize(function () {
        _this2._fixHeight()

        _this2._fixScrollHeight()
      })
      $__default["default"](globalThis).scroll(function () {
        var $body = $__default["default"]('body')
    ...
    _proto._fixScrollHeight = function _fixScrollHeight() {
      ...
      var heights = {
        ...
        window: $__default["default"](globalThis).height(),
        header: $__default["default"](SELECTOR_HEADER$1).outerHeight(),
        footer: $__default["default"](SELECTOR_FOOTER$1).outerHeight()
      }
      var positions = {
        bottom: Math.abs(heights.window + $__default["default"](globalThis).scrollTop() - heights.scroll),
        top: $__default["default"](globalThis).scrollTop()
      }
    ...
    _proto._fixHeight = function _fixHeight() {
      ...
      if ($__default["default"].fn.overlayScrollbars !== undefined) {
  ...
  var Dropdown = /*#__PURE__*/function () {
    ...
    _proto.fixPosition = function fixPosition() {
      ...
      var visiblePart = $__default["default"](globalThis).width() - offset.left
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.toggleFullscreen = function toggleFullscreen() {
      ...
      $__default["default"](globalThis).trigger('resize')
    ...
    _proto._setupListeners = function _setupListeners() {
      ...
      $__default["default"](globalThis).on('resize', function () {
        setTimeout(function () {
          _this3._fixHeight()
        }, 1)
      })
    ...
    _proto._fixHeight = function _fixHeight(tabEmpty) {
      ...
      if ($__default["default"]('body').hasClass(CLASS_NAME_FULLSCREEN_MODE)) {
        var windowHeight = $__default["default"](globalThis).height()
  ...
  $__default["default"](globalThis).on('load', function () {
  ...
  var PushMenu = /*#__PURE__*/function () {
    ...
    _proto.expand = function expand() {
      ...
      if (this._options.autoCollapseSize && $__default["default"](globalThis).width() <= this._options.autoCollapseSize) {
    ...
    _proto.autoCollapse = function autoCollapse(resize) {
      ...
      if ($__default["default"](globalThis).width() <= this._options.autoCollapseSize) {
