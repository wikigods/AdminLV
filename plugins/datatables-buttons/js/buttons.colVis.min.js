...
*/
(function(h){"function"===typeof define&&define.amd?define(["jquery","datatables.net","datatables.net-buttons"],function(e){return h(e,globalThis,document)}):("object"===typeof exports?module.exports=function(e,g){e||(e=globalThis);g&&g.fn.dataTable||(g=require("datatables.net")(e,g).$);g.fn.dataTable.Buttons||require("datatables.net-buttons")(e,g);return h(g,e,e.document)}:h(jQuery,globalThis,document))})(function(h,e,g,l){e=h.fn.dataTable;h.extend(e.ext.buttons,{ colvis:function(b,a){var c=null,d={ extend:"collection",
  ...
  a=b.visible();b.visible(d.visibility===l?!(a.length > 0&&a[0]):d.visibility)},init:function(b,a,c){var d=this;a.attr("data-cv-idx",c.columns);b.on(`column-visibility.dt${c.namespace}`,function(f,k){k.bDestroying||k.nTable!=b.settings()[0].nTable||d.active(b.column(c.columns).visible())}).on(`column-reorder.dt${c.namespace}`,function(f,k,m){c.destroying||1!==b.columns(c.columns).count()||(d.text(c._columnText(b,c)),d.active(b.column(c.columns).visible()))});this.active(b.column(c.columns).visible())},destroy:function(b,
  a,c){b.off(`column-visibility.dt${c.namespace}`).off(`column-reorder.dt${c.namespace}`)},_columnText:function(b,a){var c=b.column(a.columns).index(),d=b.settings()[0].aoColumns[c].sTitle;d||(d=b.column(c).header().innerHTML);d=d.replaceAll('\n'," ").replaceAll(/<br\s*\/?>/gi," ").replaceAll(/<select(.*?)<\/select>/g,"").replaceAll(/<!\-\-.*?\-\->/g,"").replaceAll(/<.*?>/g,"").replaceAll(/^\s+|\s+$/g,"");return a.columnText?a.columnText(b,c,d):d} },colvisRestore:{ className:"buttons-colvisRestore",text:function(b){return b.i18n("buttons.colvisRestore",
