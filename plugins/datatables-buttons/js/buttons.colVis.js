  ...
  $.extend( DataTable.ext.buttons, {
    ...
    columnVisibility: {
      ...
      _columnText: function ( dt, conf ) {
        ...
        title = title
				.replaceAll('\n'," ")        // remove new lines
				.replaceAll(/<br\s*\/?>/gi, " ")  // replace line breaks with spaces
				.replaceAll(/<select(.*?)<\/select>/g, "") // remove select tags, including options text
				.replaceAll(/<!\-\-.*?\-\->/g, "") // strip HTML comments
