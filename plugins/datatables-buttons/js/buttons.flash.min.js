...
(function(f){"function"===typeof define&&define.amd?define(["jquery","datatables.net","datatables.net-buttons"],function(q){return f(q,globalThis,document)}):("object"===typeof exports?module.exports=function(q,r){q||(q=globalThis);r&&r.fn.dataTable||(r=require("datatables.net")(q,r).$);r.fn.dataTable.Buttons||require("datatables.net-buttons")(q,r);return f(r,q,q.document)}:f(jQuery,globalThis,document))})(function(f,q,r,y){function t(a,b,c){var d=a.createElement(b);c&&(c.attr&&f(d).attr(c.attr),c.children&&f.each(c.children,
  ...
  f.each(a,function(b,c){if(f.isPlainObject(c))K(c);else{if(E){var d=c.childNodes[0],g,e=[];for(g=d.attributes.length-1;0<=g;g--){var n=d.attributes[g].nodeName;var m=d.attributes[g].nodeValue;-1!==n.indexOf(":")&&(e.push({ name:n,value:m }),d.removeAttribute(n))}g=0;for(n=e.length;g<n;g++)m=c.createAttribute(e[g].name.replace(":","_dt_b_namespace_token_")),m.value=e[g].value,d.setAttributeNode(m)}c=I.serializeToString(c);E&&(-1===c.indexOf("<?xml")&&(c=`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>${
    c}`),c=c.replaceAll('_dt_b_namespace_token_',":"));c=c.replaceAll(/<([^<>]*?) xmlns=""([^<>]*?)>/g,"<$1 $2>");a[b]=c}})}var z=f.fn.dataTable,l={ version:"1.0.4-TableTools2",clients:{},moviePath:"",nextId:1,$:function(a){"string"==typeof a&&(a=r.getElementById(a));a.addClass||(a.hide=function(){this.style.display="none"},a.show=function(){this.style.display=""},a.addClass=function(b){this.removeClass(b);this.className+=` ${b}`},a.removeClass=function(b){this.className=this.className.replace(new RegExp(String.raw`\s*`+
b+String.raw`\s*`)," ").replace(/^\s+/,"").replace(/\s+$/,"")},a.hasClass=function(b){return!!new RegExp(String.raw`\s*`+b+String.raw`\s*`).test(this.className)});return a},setMoviePath:function(a){this.moviePath=a},dispatch:function(a,b,c){(a=this.clients[a])&&a.receiveEvent(b,c)},log:function(a){console.log(`Flash: ${a}`)},register:function(a,b){this.clients[a]=b},getDOMObjectPosition:function(a){var b={ left:0,top:0,width:a.width?a.width:a.offsetWidth,height:a.height?a.height:a.offsetHeight };""!==a.style.width&&(b.width=a.style.width.replace("px",
...
(a=parseInt(this.domElement.style.zIndex,10)+1);var c=l.getDOMObjectPosition(this.domElement);this.div=r.createElement("div");var d=this.div.style;d.position="absolute";d.left="0px";d.top="0px";d.width=`${c.width}px`;d.height=`${c.height}px`;d.zIndex=a;"undefined"!=typeof b&&""!==b&&(this.div.title=b);0!==c.width&&0!==c.height&&(this.sized=!0);this.domElement&&(this.domElement.appendChild(this.div),this.div.innerHTML=this.getHTML(c.width,c.height).replaceAll('&',"&amp;"))},positionElement:function(){var a=
l.getDOMObjectPosition(this.domElement),b=this.div.style;b.position="absolute";b.width=`${a.width}px`;b.height=`${a.height}px`;0!==a.width&&0!==a.height&&(this.sized=!0,b=this.div.childNodes[0],b.width=a.width,b.height=a.height)},getHTML:function(a,b){var c="",d=`id=${this.id}&width=${a}&height=${b}`;if(/MSIE/.test(navigator.userAgent)){var g=/^https/i.test(location.href)?"https://":"http://";c+=`<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="${g}download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="${
...
0,g=this.handlers[a].length;d<g;d++){var e=this.handlers[a][d];if("function"==typeof e)e(this,b);else if("object"==typeof e&&2==e.length)e[0][e[1]](this,b);else if("string"==typeof e)q[e](this,b)}} };l.hasFlash=function(){try{return new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),!0}catch(error){if(navigator.mimeTypes&&navigator.mimeTypes["application/x-shockwave-flash"]!==y&&navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin)return!0}return!1};q.ZeroClipboard_TableTools=l;var L=function(a,
    b){b.attr("id");b.parents("html").length > 0?a.glue(b[0],""):setTimeout(function(){L(a,b)},500)},F=function(a,b){var c="*"===a.filename&&"*"!==a.title&&a.title!==y?a.title:a.filename;"function"===typeof c&&(c=c());-1!==c.indexOf("*")&&(c=f.trim(c.replace("*",f("title").text())));c=c.replaceAll(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g,"");return b===y||!0===b?c+a.extension:c},P=function(a){var b="Sheet1";a.sheetName&&(b=a.sheetName.replaceAll(/[\[\]\*\/\\\?:]/g,""));return b},G=function(a,b){b=b.match(/[\s\S]{1,8192}/g)||
[];a.clearText();for(var c=0,d=b.length;c<d;c++)a.appendText(b[c])},M=function(a,b){var c=b.newline?b.newline:(/Windows/.test(navigator.userAgent)?"\r\n":"\n");a=a.buttons.exportData(b.exportOptions);var d=b.fieldBoundary,g=b.fieldSeparator,e=new RegExp(d,"g"),n=b.escapeChar===y?"\\":b.escapeChar,m=function(k){for(var h="",B=0,u=k.length;B<u;B++)0<B&&(h+=g),h+=d?d+(`${k[B]}`).replace(e,n+d)+d:k[B];return h},C=b.header?m(a.header)+c:"";b=b.footer&&a.footer?c+m(a.footer):"";for(var v=[],p=0,D=a.body.length;p<
...
typeof q.XMLSerializer?
  new function(){this.serializeToString=function(a){return a.xml}}:
  new XMLSerializer;var E,A={ "_rels/.rels":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workbook.xml"/></Relationships>',"xl/_rels/workbook.xml.rels":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="worksheets/sheet1.xml"/><Relationship Id="rId2" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles" Target="styles.xml"/></Relationships>',
  ...
  N=[{ match:/^\-?\d+\.\d%$/,style:60,fmt:function(a){return a/100} },{ match:/^\-?\d+\.?\d*%$/,style:56,fmt:function(a){return a/100} },{ match:/^\-?\$[\d,]+.?\d*$/,style:57 },{ match:/^\-?£[\d,]+.?\d*$/,style:58 },{ match:/^\-?€[\d,]+.?\d*$/,style:59 },{ match:/^\([\d,]+\)$/,style:61,fmt:function(a){return-1*a.replaceAll(/[\(\)]/g,"")} },{ match:/^\([\d,]+\.\d{2}\)$/,style:62,fmt:function(a){return-1*a.replaceAll(/[\(\)]/g,"")} },{ match:/^[\d,]+$/,style:63 },{ match:/^[\d,]+\.\d{2}$/,style:64 }];z.Buttons.swfPath="//cdn.datatables.net/buttons/1.2.4/swf/flashExport.swf"
z.Api.register("buttons.resize()",function(){f.each(l.clients,function(a,b){b.domElement!==y&&b.domElement.parentNode&&b.positionElement()})});z.ext.buttons.copyFlash=f.extend({},H,{ className:"buttons-copy buttons-flash",text:function(a){return a.i18n("buttons.copy","Copy")},action:function(a,b,c,d){d._fromFlash&&(this.processing(!0),a=d._flash,c=M(b,d),d=d.customize?d.customize(c.str,d):c.str,a.setAction("copy"),G(a,d),this.processing(!1),b.buttons.info(b.i18n("buttons.copyTitle","Copy to clipboard"),
  ...
  text:function(a){return a.i18n("buttons.excel","Excel")},action:function(a,b,c,d){this.processing(!0);a=d._flash;var g=0,e=f.parseXML(A["xl/worksheets/sheet1.xml"]),n=e.getElementsByTagName("sheetData")[0];c={ _rels:{ ".rels":f.parseXML(A["_rels/.rels"]) },xl:{ _rels:{ "workbook.xml.rels":f.parseXML(A["xl/_rels/workbook.xml.rels"]) },"workbook.xml":f.parseXML(A["xl/workbook.xml"]),"styles.xml":f.parseXML(A["xl/styles.xml"]),worksheets:{ "sheet1.xml":e } },"[Content_Types].xml":f.parseXML(A["[Content_Types].xml"]) }
    b=b.buttons.exportData(d.exportOptions);var m,C,v=function(k){m=g+1;C=t(e,"row",{ attr:{ r:m } });for(var h=0,B=k.length;h<B;h++){for(var u=h,w="";0<=u;)w=String.fromCharCode(u%26+65)+w,u=Math.floor(u/26)-1;u=`${w}${m}`;var x=null;if(null!==k[h]&&k[h]!==y&&""!==k[h]){k[h]=f.trim(k[h]);for(var J=0,Q=N.length;J<Q;J++)if(w=N[J],k[h].match&&!/^0\d+/.test(k[h])&&k[h].match(w.match)){x=k[h].replaceAll(/[^\d\.\-]/g,"");w.fmt&&(x=w.fmt(x));x=t(e,"c",{ attr:{ r:u,s:w.style },children:[t(e,"v",{ text:x })] });break}x||("number"===
typeof k[h]||k[h].match&&/^-?\d+(\.\d+)?$/.test(k[h])&&!/^0\d+/.test(k[h])?
      x=t(e,"c",{ attr:{ t:"n",r:u },children:[t(e,"v",{ text:k[h] })] }):
      (w=k[h].replace?k[h].replaceAll(/[\u0000-\u0009\u000B\u000C\u000E-\u001F\u007F-\u009F]/g,""):k[h],x=t(e,"c",{ attr:{ t:"inlineStr",r:u },children:{ row:t(e,"is",{ children:{ row:t(e,"t",{ text:w }) } }) } })));C.appendChild(x)}}n.appendChild(C);g++};f("sheets sheet",c.xl["workbook.xml"]).attr("name",P(d));d.customizeData&&d.customizeData(b);d.header&&(v(b.header,g),f("row c",e).attr("s","2"))
