...
(function () {
  ...
  var SearchPane = /** @class */ (function () {
    ...
    function SearchPane(paneSettings, opts, idx, layout, panesContainer, panes) {
      ...
      if (this.c.clear) {
        clear.on('click', function () {
          var searches = _this.dom.container.find(`.${  _this.classes.search.replaceAll(/\s+/g, '.')}`)
    ...
    SearchPane.prototype.adjustTopRow = function () {
      var subContainers = this.dom.container.find(`.${  this.classes.subRowsContainer.replaceAll(/\s+/g, '.')}`)
      var subRow1 = this.dom.container.find(`.${  this.classes.subRow1.replaceAll(/\s+/g, '.')}`)
      var subRow2 = this.dom.container.find(`.${  this.classes.subRow2.replaceAll(/\s+/g, '.')}`)
      var topRow = this.dom.container.find(`.${  this.classes.topRow.replaceAll(/\s+/g, '.')}`)
    ...
    SearchPane.prototype.rebuildPane = function (last, dataIn, init, maintainSelection) {
      ...
      this._buildPane(this.s.dt.page.info().serverSide ?
        this.s.serverSelect :
        selectedRows, last, dataIn, init, prevEl)
      return this
    }
    /**
    ...
    SearchPane.prototype._setListeners = function () {
      ...
      this.dom.clear.on('click.dtsp', function () {
        var searches = _this.dom.container.find(`.${  _this.classes.search.replaceAll(' ', '.')}`)
        searches.each(function () {
    ...
    SearchPane.prototype._uniqueRatio = function (bins, rowCount) {
      return rowCount > 0 &&
        ...
        bins / this.s.rowData.totalOptions :
        1
    }
    /**
          ...
          var _loop_1 = function (dataP) {
            ...
            if (dataP &&
              ...
              var row = this_1.addRow(dataP.display, dataP.filter, this_1.c.viewTotal ?
                ...
                rowData.bins[dataP.filter], this_1.c.viewTotal ?
  ...
  var SearchPanes = /** @class */ (function () {
    ...
    SearchPanes.prototype.clearSelections = function () {
      ...
      var searches = this.dom.container.find(`.${  this.classes.search.replaceAll(/\s+/g, '.')}`)
    ...
    SearchPanes.prototype.rebuild = function (targetIdx, maintainSelection) {
      ...
      for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
        ...
        returnArray.push(
          ...
          pane.rebuildPane(this.s.selectionList.at(-1) === undefined ?
            false :
            pane.s.index === this.s.selectionList.at(-1).index, this.s.dt.page.info().serverSide ?
            this.s.serverData :
        ...
        if (this.regenerating) {
          ...
          for (var _r = 0, _s = this.s.panes; _r < _s.length; _r++) {
            ...
            if (pane.s.dtPane !== undefined) {
              ...
              pane.updatePane(tempFilter ? filterActive : tempFilter)
            }
          }
          ...
          if (this.s.selectionList.length > 0) {
            var last = this.s.selectionList.at(-1).index
          ...
          for (var _k = 0, _l = this.s.panes; _k < _l.length; _k++) {
            ...
            if (pane.s.dtPane !== undefined) {
              ...
              pane.updatePane(tempFilter ? filterActive : false)
            }
          }
          ...
          if (newSelectionList.length > 0 && (newSelectionList.length < this.s.selectionList.length || rebuild)) {
            ...
            var last = newSelectionList.at(-1).index
            ...
            for (var _p = 0, _q = this.s.panes; _p < _q.length; _p++) {
              ...
              if (paneUpdate.s.dtPane !== undefined) {
                ...
                paneUpdate.updatePane(tempFilter ? filterActive : tempFilter)
              }
            }
          }
          // Update the label that shows how many filters are in place
    ...
    SearchPanes.prototype.resizePanes = function () {
      if (this.c.layout === 'auto') {
        ...
        var target = Math.floor(contWidth / 260) // The neatest number of panes per row
        var highest = 1
        var highestmod = 0
        var dispIndex = []
        ...
        var widerIndexes = highestmod === 0 ? [] : dispIndex.slice(dispIndex.length - highestmod)
        for (var _b = 0, _c = this.s.panes; _b < _c.length; _b++) {
          var pane = _c[_b]
          // Resize the pane with the new layout
          if (pane.s.displayed) {
            var layout = `columns-${  widerIndexes.includes(pane.s.index) ? highestmod : highest}`
            pane.resize(layout)
          }
        }
      }
    ...
    SearchPanes.prototype._startup = function (table) {
      ...
      this.dom.panes.empty()
      var loadedFilter = this.s.dt.state.loaded()
      if (this.c.viewTotal && !this.c.cascadePanes && loadedFilter !== null &&
      ...
      $$1(globalThis).on('resize.dtsp', dataTable$1.util.throttle(function () {
        _this.resizePanes()
      }))
        ...
        if (!_this.s.dt.page.info().serverSide) {
          _this.s.dt.one('preDraw', function () {
            ...
            for (var _i = 0, _a = _this.s.panes; _i < _a.length; _i++) {
              ...
              // when rebuilding
              pane.rebuildPane(_this.s.selectionList.at(-1) === undefined ?
                false :
                pane.s.index === _this.s.selectionList.at(-1).index, undefined, undefined, true)
  ...
  (function (factory) {
    if (typeof define === 'function' && define.amd) {
      ...
      factory(globalThis.jQuery, globalThis, document)
    }
        ...
        var panes = new $.fn.dataTable.SearchPanes(dt, $.extend({
          filterChanged: function (count) {
            ...
            dt.button(node).text(dt.i18n('searchPanes.collapse', dt.context[0].oLanguage.searchPanes === undefined ?
              ...
              dt.context[0].oLanguage.searchPanes.collapse, count))
          }
        }, config.config))
    ...
    $(document).on('preInit.dt.dtsp', function (e, settings, json) {
      ...
      if ((settings.oInit.searchPanes ||
                dataTable.defaults.searchPanes) && !settings._searchPanes) {
