...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.getGlobal=function(n){n=["object"==typeof globalThis&&globalThis,n,"object"==typeof globalThis.window&&globalThis,"object"==typeof globalThis.self&&globalThis,"object"==typeof globalThis.global&&globalThis];for(var q=0;q<n.length;++q){var l=n[q];if(l&&l.Math==Math)return l}throw new Error("Cannot find global object")};$jscomp.global=$jscomp.getGlobal(this)
$jscomp.checkEs6ConformanceViaProxy=function(){try{var n={},q=Object.create(new $jscomp.global.Proxy(n,{ get:function(l,r,t){return l==n&&"q"==r&&t==q} }));return!0===q.q}catch(error){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();$jscomp.arrayIteratorImpl=function(n){var q=0;return function(){return q<n.length?{ done:!1,value:n[q++] }:{ done:!0 }}};$jscomp.arrayIterator=function(n){return{ next:$jscomp.arrayIteratorImpl(n) }}
...
$jscomp.polyfills={};$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";var $jscomp$lookupPolyfilledValue=function(n,q){var l=$jscomp.propertyToPolyfillSymbol[q];if(null==l)return n[q];l=n[l];return void 0===l?n[q]:l};$jscomp.polyfill=function(n,q,l,r){q&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(n,q,l,r):$jscomp.polyfillUnisolated(n,q,l,r))}
$jscomp.polyfillUnisolated=function(n,q,l,r){l=$jscomp.global;n=n.split(".");for(r=0;r<n.length-1;r++){var t=n[r];if(!(t in l))return;l=l[t]}n=n.at(-1);r=l[n];q=q(r);q!=r&&null!=q&&$jscomp.defineProperty(l,n,{ configurable:!0,writable:!0,value:q })}
$jscomp.polyfillIsolated=function(n,q,l,r){var t=n.split(".");n=1===t.length;r=t[0];r=!n&&r in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var v=0;v<t.length-1;v++){var A=t[v];if(!(A in r))return;r=r[A]}t=t.at(-1);l=$jscomp.IS_SYMBOL_NATIVE&&"es6"===l?r[t]:null;q=q(l);null!=q&&(n?
...
$jscomp.polyfill("Map",function(n){function q(){if($jscomp.ASSUME_NO_NATIVE_MAP||!n||"function"!=typeof n||!n.prototype.entries||"function"!=typeof Object.seal)return!1;try{var h=Object.seal({ x:4 }),a=new n($jscomp.makeIterator([[h,"s"]]));if("s"!=a.get(h)||1!=a.size||a.get({ x:4 })||a.set({ x:4 },"t")!=a||2!=a.size)return!1;var b=a.entries(),c=b.next();if(c.done||c.value[0]!=h||"s"!=c.value[1])return!1;c=b.next();return c.done||4!=c.value[0].x||"t"!=c.value[1]||!b.next().done?!1:!0}catch(error){return!1}}
  if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(n&&$jscomp.ES6_CONFORMANCE)return n}else if(q())return n;var l=new WeakMap,r=function(h){this.data_={};this.head_=A();this.size=0;if(h){h=$jscomp.makeIterator(h);for(var a;!(a=h.next()).done;)a=a.value,this.set(a[0],a[1])}};r.prototype.set=function(h,a){h=0===h?0:h;var b=t(this,h);b.list||(b.list=this.data_[b.id]=[]);b.entry?
    b.entry.value=a:
    (b.entry={ next:this.head_,previous:this.head_.previous,head:this.head_,key:h,value:a },b.list.push(b.entry),
...
t(this,h).entry)&&h.value};r.prototype.entries=function(){return v(this,function(h){return[h.key,h.value]})};r.prototype.keys=function(){return v(this,function(h){return h.key})};r.prototype.values=function(){return v(this,function(h){return h.value})};r.prototype.forEach=function(h,a){for(var b=this.entries(),c;!(c=b.next()).done;)c=c.value,h.call(a,c[1],c[0],this)};r.prototype[Symbol.iterator]=r.prototype.entries;var t=function(h,a){var b=a&&typeof a;"object"==b||"function"==b?
      (l.has(a)?
        b=l.get(a):
        (b=`${ ++F}`,l.set(a,b))):
      b=`p_${a}`;var c=h.data_[b];if(c&&$jscomp.owns(h.data_,b))for(h=0;h<c.length;h++){var e=c[h];if(a!==a&&e.key!==e.key||a===e.key)return{ id:b,list:c,index:h,entry:e }}return{ id:b,list:c,index:-1,entry:void 0 }},v=function(h,a){var b=h.head_;return $jscomp.iteratorPrototype(function(){if(b){for(;b.head!=h.head_;)b=b.previous;for(;b.next!=b.head;)return b=b.next,{ done:!1,value:a(b) };b=null}return{ done:!0,value:void 0 }})},A=function(){var h={};return h.previous=h.next=h.head=h},F=0
...
(function(){function n(h){l=h;r=h.fn.dataTable}function q(h){v=h;A=h.fn.dataTable}var l,r,t=function(){function h(a,b,c,e,d,f){var g=this;void 0===f&&(f=null);if(!r||!r.versionCheck||!r.versionCheck("1.10.0"))throw new Error("SearchPane requires DataTables 1.10 or newer");if(!r.select)throw new Error("SearchPane requires Select");a=new r.Api(a);this.classes=l.extend(!0,{},h.classes);this.c=l.extend(!0,{},h.defaults,b);void 0!==b&&void 0!==b.hideCount&&void 0===b.viewCount&&(this.c.viewCount=!this.c.hideCount)
    ...
    b=a.columns().eq(0).toArray().length;this.colExists=this.s.index<b;this.c.layout=e;b=parseInt(e.split("-")[1],10);this.dom={ buttonGroup:l("<div/>").addClass(this.classes.buttonGroup),clear:l('<button type="button">&#215;</button>').addClass(this.classes.disabledButton).attr("disabled","true").addClass(this.classes.paneButton).addClass(this.classes.clearButton),collapseButton:l('<button type="button"><span class="dtsp-caret">&#x5e;</span></button>').addClass(this.classes.paneButton).addClass(this.classes.collapseButton),
      ...
      "");this.s.name=void 0===this.s.colOpts.name?null!==this.customPaneSettings&&void 0!==this.customPaneSettings.name?this.customPaneSettings.name:this.colExists?l(a.column(this.s.index).header()).text():this.customPaneSettings.header||"Custom Pane":this.s.colOpts.name;l(d).append(this.dom.container);var p=a.table(0).node();this.s.searchFunction=function(m,x,z,y){if(g.selections.length === 0||m.nTable!==p)return!0;m=null;g.colExists&&(m=x[g.s.index],"filter"!==k.orthogonal.filter&&
(m=g.s.rowData.filterMap.get(z),m instanceof l.fn.dataTable.Api&&(m=m.toArray())));return g._search(m,z)};l.fn.dataTable.ext.search.push(this.s.searchFunction);if(this.c.clear)e.on("click",function(){g.dom.container.find(`.${g.classes.search.replaceAll(/\s+/g,".")}`).each(function(){l(this).val("");l(this).trigger("input")});g.clearPane()});a.on("draw.dtsp",function(){g.adjustTopRow()});a.on("buttons-action",function(){g.adjustTopRow()});a.on("column-reorder.dtsp",function(m,x,z){g.s.index=z.mapping[g.s.index]})
    return this}h.prototype.addRow=function(a,b,c,e,d,f,g){for(var k,p=0,m=this.s.indexes;p<m.length;p++){var x=m[p];x.filter===b&&(k=x.index)}void 0===k&&(k=this.s.indexes.length,this.s.indexes.push({ filter:b,index:k }));return this.s.dtPane.row.add({ className:g,display:""===a?this.emptyMessage():a,filter:b,index:k,shown:c,sort:d,total:e,type:f })};h.prototype.adjustTopRow=function(){var a=this.dom.container.find(`.${this.classes.subRowsContainer.replaceAll(/\s+/g,".")}`),b=this.dom.container.find(`.${this.classes.subRow1.replaceAll(/\s+/g,
      ".")}`),c=this.dom.container.find(`.${this.classes.subRow2.replaceAll(/\s+/g,".")}`),e=this.dom.container.find(`.${this.classes.topRow.replaceAll(/\s+/g,".")}`);(252>l(a[0]).width()||252>l(e[0]).width())&&0!==l(a[0]).width()?
    (l(a[0]).addClass(this.classes.narrow),l(b[0]).addClass(this.classes.narrowSub).removeClass(this.classes.narrowSearch),l(c[0]).addClass(this.classes.narrowSub).removeClass(this.classes.narrowButton)):
    (l(a[0]).removeClass(this.classes.narrow),l(b[0]).removeClass(this.classes.narrowSub).addClass(this.classes.narrowSearch),
...
(a=this.s.colOpts.emptyMessage);return this.s.dt.i18n("searchPanes.emptyMessage",a)};h.prototype.getPaneCount=function(){return void 0===this.s.dtPane?0:this.s.dtPane.rows({ selected:!0 }).data().toArray().length};h.prototype.rebuildPane=function(a,b,c,e){void 0===a&&(a=!1);void 0===b&&(b=null);void 0===c&&(c=null);void 0===e&&(e=!1);this.clearData();var d=[];this.s.serverSelect=[];var f=null;void 0!==this.s.dtPane&&(e&&(this.s.dt.page.info().serverSide?
...
function(){this.selections=this.s.dtPane.rows({ selected:!0 }).data().toArray();this._searchExtras();(this.c.cascadePanes||this.c.viewTotal)&&this.updatePane()};h.prototype._setListeners=function(){var a=this,b=this.s.rowData,c;this.s.dtPane.off("select.dtsp");this.s.dtPane.on("select.dtsp",function(){clearTimeout(c);a.s.dt.page.info().serverSide&&!a.s.updating?
    a.s.serverSelecting||(a.s.serverSelect=a.s.dtPane.rows({ selected:!0 }).data().toArray(),a.s.scrollTop=l(a.s.dtPane.table().node()).parent()[0].scrollTop,
    a.s.selectPresent=!0,a.s.dt.draw(!1)):
    a.s.updating||(a.s.selectPresent=!0,a._makeSelection(),a.s.selectPresent=!1);a.dom.clear.removeClass(a.classes.disabledButton).removeAttr("disabled")});this.s.dtPane.off("deselect.dtsp");this.s.dtPane.on("deselect.dtsp",function(){c=setTimeout(function(){a.s.scrollTop=l(a.s.dtPane.table().node()).parent()[0].scrollTop;a.s.dt.page.info().serverSide&&!a.s.updating?
    a.s.serverSelecting||(a.s.serverSelect=a.s.dtPane.rows({ selected:!0 }).data().toArray(),a.s.deselect=
!0,a.s.dt.draw(!1)):
    (a.s.deselect=!0,a._makeSelection(),a.s.deselect=!1);a.s.dtPane.rows({ selected:!0 }).data().toArray().length === 0&&a.dom.clear.addClass(a.classes.disabledButton).attr("disabled","true")},50)});this.s.firstSet&&(this.s.firstSet=!1,this.s.dt.on("stateSaveParams.dtsp",function(e,d,f){if(l.isEmptyObject(f))a.s.dtPane.state.clear();else{e=[];if(void 0!==a.s.dtPane){e=a.s.dtPane.rows({ selected:!0 }).data().map(function(z){return z.filter.toString()}).toArray();var g=a.dom.searchBox.val()
...
!0!==p.show)&&-1===w)return this.dom.container.addClass(this.classes.hidden),this.s.displayed=!1;if(!0===p.show||-1!==w)this.s.displayed=!0;if(!this.s.dt.page.info().serverSide&&(null===c||null===c.searchPanes||null===c.searchPanes.options)){m.arrayFilter.length === 0&&(this._populatePane(b),this.s.rowData.totalOptions=0,this._detailsPane(),m.arrayOriginal=m.arrayTotals,m.binsOriginal=m.binsTotal);u=Object.keys(m.binsOriginal).length;b=this._uniqueRatio(u,g.rows()[0].length);if(!1===this.s.displayed&&
((void 0===p.show&&null===p.threshold?b>this.c.threshold:b>p.threshold)||!0!==p.show&&1>=u)){this.dom.container.addClass(this.classes.hidden);this.s.displayed=!1;return}this.c.viewTotal&&m.arrayTotals.length === 0?(this.s.rowData.totalOptions=0,this._detailsPane()):m.binsTotal=m.bins;this.dom.container.addClass(this.classes.show);this.s.displayed=!0}else if(null!==c&&null!==c.searchPanes&&null!==c.searchPanes.options){if(void 0!==c.tableLength)this.s.tableLength=c.tableLength,this.s.rowData.totalOptions=
...
w.total;u=Object.keys(m.binsTotal).length;b=this._uniqueRatio(u,this.s.tableLength);if(!1===this.s.displayed&&((void 0===p.show&&null===p.threshold?b>this.c.threshold:b>p.threshold)||!0!==p.show&&1>=u)){this.dom.container.addClass(this.classes.hidden);this.s.displayed=!1;return}this.s.rowData.arrayOriginal=this.s.rowData.arrayFilter;this.s.rowData.binsOriginal=this.s.rowData.bins;this.s.displayed=!0}}else this.s.displayed=!0;this._displayPane();if(!this.s.listSet)this.dom.dtP.on("stateLoadParams.dt",
    function(C,G,D){l.isEmptyObject(g.state.loaded())&&l.each(D,function(E,I){delete D[E]})});null!==d&&this.dom.panesContainer.has(d).length > 0?this.dom.container.insertAfter(d):this.dom.panesContainer.prepend(this.dom.container);u=l.fn.dataTable.ext.errMode;l.fn.dataTable.ext.errMode="none";d=r.Scroller;this.s.dtPane=this.dom.dtP.DataTable(l.extend(!0,{ columnDefs:[{ className:"dtsp-nameColumn",data:"display",render:function(C,G,D){if("sort"===G)return D.sort;if("type"===G)return D.type;var E=(f.s.filteringActive||
f.s.showFiltered)&&f.c.viewTotal||f.c.viewTotal&&f.s.forceViewTotal?
    z.replace(/{total}/,D.total):
    x.replace(/{total}/,D.total);for(E=E.replace(/{shown}/,D.shown);E.includes("{total}");)E=E.replace(/{total}/,D.total);for(;E.includes("{shown}");)E=E.replace(/{shown}/,D.shown);D=`<span class="${f.classes.pill}">${E}</span>`;f.c.viewCount&&p.viewCount||(D="");return"filter"===G?
    ("string"===typeof C&&null!==C.match(/<[^>]*>/)?C.replaceAll(/<[^>]*>/g,""):C):
    `<div class="${f.classes.nameCont}"><span title="${
      "string"===typeof C&&null!==C.match(/<[^>]*>/)?C.replaceAll(/<[^>]*>/g,""):C}" class="${f.classes.name}">${C}</span>${D}</div>`},targets:0,type:void 0===g.settings()[0].aoColumns[this.s.index]?null:g.settings()[0].aoColumns[this.s.index]._sManualType },{ className:`dtsp-countColumn ${this.classes.badgePill}`,data:"shown",orderData:[1,2],searchable:!1,targets:1,visible:!1 },{ data:"total",searchable:!1,targets:2,visible:!1 }],deferRender:!0,dom:"t",info:!1,language:this.s.dt.settings()[0].oLanguage,paging:d?
    !0:
  ...
  d="Custom Pane";this.customPaneSettings&&this.customPaneSettings.header?d=this.customPaneSettings.header:(p.header?d=p.header:this.colExists&&(d=l.fn.dataTable.versionCheck("2")?g.column(this.s.index).title():g.settings()[0].aoColumns[this.s.index].sTitle));this.dom.searchBox.attr("placeholder",d);l.fn.dataTable.select.init(this.s.dtPane);l.fn.dataTable.ext.errMode=u;if(this.colExists){k=(k=k.search())?k.substr(1,k.length-2).split("|"):[];var B=0;m.arrayFilter.forEach(function(C){""===C.filter&&B++})
    u=0;for(d=m.arrayFilter.length;u<d;u++){k=!1;w=0;for(var H=this.s.serverSelect;w<H.length;w++)b=H[w],b.filter===m.arrayFilter[u].filter&&(k=!0);if(this.s.dt.page.info().serverSide&&(!this.c.cascadePanes||this.c.cascadePanes&&0!==m.bins[m.arrayFilter[u].filter]||this.c.cascadePanes&&null!==e||k))for(k=this.addRow(m.arrayFilter[u].display,m.arrayFilter[u].filter,e?m.binsTotal[m.arrayFilter[u].filter]:m.bins[m.arrayFilter[u].filter],this.c.viewTotal||e?String(m.binsTotal[m.arrayFilter[u].filter]):m.bins[m.arrayFilter[u].filter],
      m.arrayFilter[u].sort,m.arrayFilter[u].type),w=0,H=this.s.serverSelect;w<H.length;w++)b=H[w],b.filter===m.arrayFilter[u].filter&&(this.s.serverSelecting=!0,k.select(),this.s.serverSelecting=!1);else this.s.dt.page.info().serverSide||!m.arrayFilter[u]||void 0===m.bins[m.arrayFilter[u].filter]&&this.c.cascadePanes?
      this.s.dt.page.info().serverSide||this.addRow("",B,B,"","",""):
      this.addRow(m.arrayFilter[u].display,m.arrayFilter[u].filter,m.bins[m.arrayFilter[u].filter],m.binsTotal[m.arrayFilter[u].filter],
...
(null===c||1===c.draw))for(this.c.cascadePanes||this._reloadSelect(y),c=0,y=y.searchPanes.panes;c<y.length;c++)a=y[c],a.id===this.s.index&&(a.searchTerm&&a.searchTerm.length > 0&&(this.dom.searchBox.val(a.searchTerm),this.dom.searchBox.trigger("input")),this.s.dtPane.order(a.order).draw(),a.collapsed?this.collapse():this.show());return!0};h.prototype._detailsPane=function(){var a=this.s.dt;this.s.rowData.arrayTotals=[];this.s.rowData.binsTotal={};var b=this.s.dt.settings()[0];a=a.rows().indexes();if(!this.s.dt.page.info().serverSide)for(var c=
0;c<a.length;c++)this._populatePaneArray(a[c],this.s.rowData.arrayTotals,b,this.s.rowData.binsTotal)};h.prototype._displayPane=function(){var a=this.dom.container,b=this.s.colOpts,c=parseInt(this.c.layout.split("-")[1],10);this.dom.topRow.empty();this.dom.dtP.empty();this.dom.topRow.addClass(this.classes.topRow);3<c&&this.dom.container.addClass(this.classes.smallGap);this.dom.topRow.addClass(this.classes.subRowsContainer);this.dom.upper.appendTo(this.dom.topRow);this.dom.lower.appendTo(this.dom.topRow)
    ...
    this.dom.topRow.prependTo(this.dom.container);a.append(this.dom.dtP);a.show()};h.prototype._getBonusOptions=function(){return l.extend(!0,{},h.defaults,{ orthogonal:{ threshold:null },threshold:null },void 0===this.c?{}:this.c)};h.prototype._getComparisonRows=function(){var a=this.s.colOpts;a=void 0===a.options?(null!==this.customPaneSettings&&void 0!==this.customPaneSettings.options?this.customPaneSettings.options:void 0):a.options;if(void 0!==a){var b=this.s.dt.rows({ search:"applied" }).data().toArray(),
    c=this.s.dt.rows({ search:"applied" }),e=this.s.dt.rows().data().toArray(),d=this.s.dt.rows(),f=[];this.s.dtPane.clear();for(var g=0;g<a.length;g++){var k=a[g],p=""===k.label?this.emptyMessage():k.label,m=k.className,x=p,z="function"===typeof k.value?k.value:[],y=0,w=p,u=0;if("function"===typeof k.value){for(var B=0;B<b.length;B++)k.value.call(this.s.dt,b[B],c[0][B])&&y++;for(B=0;B<e.length;B++)k.value.call(this.s.dt,e[B],d[0][B])&&u++;"function"!==typeof z&&z.push(k.filter)}(!this.c.cascadePanes||
...
!1};h.prototype._populatePane=function(a){void 0===a&&(a=!1);var b=this.s.dt;this.s.rowData.arrayFilter=[];this.s.rowData.bins={};var c=this.s.dt.settings()[0];if(!this.s.dt.page.info().serverSide){var e=0;for(a=(!this.c.cascadePanes&&!this.c.viewTotal||this.s.clearing||a?b.rows().indexes():b.rows({ search:"applied" }).indexes()).toArray();e<a.length;e++)this._populatePaneArray(a[e],this.s.rowData.arrayFilter,c)}};h.prototype._populatePaneArray=function(a,b,c,e){void 0===e&&(e=this.s.rowData.bins)
    var d=this.s.colOpts;if("string"===typeof d.orthogonal)c=c.oApi._fnGetCellData(c,a,this.s.index,d.orthogonal),this.s.rowData.filterMap.set(a,c),this._addOption(c,c,c,c,b,e);else{var f=c.oApi._fnGetCellData(c,a,this.s.index,d.orthogonal.search);null===f&&(f="");"string"===typeof f&&(f=f.replaceAll(/<[^>]*>/g,""));this.s.rowData.filterMap.set(a,f);e[f]?
      e[f]++:
      (e[f]=1,this._addOption(f,c.oApi._fnGetCellData(c,a,this.s.index,d.orthogonal.display),c.oApi._fnGetCellData(c,a,this.s.index,d.orthogonal.sort),
        c.oApi._fnGetCellData(c,a,this.s.index,d.orthogonal.type),b,e));this.s.rowData.totalOptions++}};h.prototype._reloadSelect=function(a){if(void 0!==a){for(var b,c=0;c<a.searchPanes.panes.length;c++)if(a.searchPanes.panes[c].id===this.s.index){b=c;break}if(void 0!==b){c=this.s.dtPane;var e=c.rows({ order:"index" }).data().map(function(g){return null===g.filter?null:g.filter.toString()}).toArray(),d=0;for(a=a.searchPanes.panes[b].selected;d<a.length;d++){b=a[d];var f=-1;null!==b&&(f=e.indexOf(b.toString()));
    -1<f&&(this.s.serverSelecting=!0,c.row(f).select(),this.s.serverSelecting=!1)}}}};h.prototype._search=function(a,b){for(var c=this.s.colOpts,e=this.s.dt,d=0,f=this.selections;d<f.length;d++){var g=f[d];"string"===typeof g.filter&&"string"===typeof a&&(g.filter=g.filter.replaceAll('&amp;',"&").replaceAll('&lt;',"<").replaceAll('&gt;',">").replaceAll('&quot;','"'));if(Array.isArray(a)){if(a.includes(g.filter))return!0}else if("function"===typeof g.filter)if(g.filter.call(e,e.row(b).data(),b)){if("or"===c.combiner)return!0}else{if("and"===
c.combiner)return!1}else if(a===g.filter||("string"!==typeof a||a.length > 0)&&a==g.filter||null===g.filter&&"string"===typeof a&&""===a)return!0}return"and"===c.combiner?!0:!1};h.prototype._searchContSetup=function(){this.c.controls&&this.s.colOpts.controls&&this.dom.searchButton.appendTo(this.dom.searchLabelCont);!1===this.c.dtOpts.searching||!1===this.s.colOpts.dtOpts.searching||null!==this.customPaneSettings&&void 0!==this.customPaneSettings.dtOpts&&void 0!==this.customPaneSettings.dtOpts.searching&&
!this.customPaneSettings.dtOpts.searching||this.dom.searchLabelCont.appendTo(this.dom.searchCont)};h.prototype._searchExtras=function(){var a=this.s.updating;this.s.updating=!0;var b=this.s.dtPane.rows({ selected:!0 }).data().pluck("filter").toArray(),c=b.indexOf(this.emptyMessage()),e=l(this.s.dtPane.table().container());-1<c&&(b[c]="");b.length > 0?e.addClass(this.classes.selected):b.length === 0&&e.removeClass(this.classes.selected);this.s.updating=a};h.prototype._uniqueRatio=function(a,b){return 0<
b&&(0<this.s.rowData.totalOptions&&!this.s.dt.page.info().serverSide||this.s.dt.page.info().serverSide&&0<this.s.tableLength)?
    ...
    1};h.prototype._updateCommon=function(a){void 0===a&&(a=!1);if(!(this.s.dt.page.info().serverSide||void 0===this.s.dtPane||this.s.filteringActive&&!this.c.cascadePanes&&!0!==a||!0===this.c.cascadePanes&&!0===this.s.selectPresent||this.s.lastSelect&&this.s.lastCascade)){a=this.s.colOpts;var b=this.s.dtPane.rows({ selected:!0 }).data().toArray(),c=
this.s.rowData;this.s.dtPane.clear();if(this.colExists){c.arrayFilter.length === 0?this._populatePane(!this.s.filteringActive):(this.c.cascadePanes&&this.s.dt.rows().data().toArray().length===this.s.dt.rows({ search:"applied" }).data().toArray().length?(c.arrayFilter=c.arrayOriginal,c.bins=c.binsOriginal):(this.c.viewTotal||this.c.cascadePanes)&&this._populatePane(!this.s.filteringActive));this.c.viewTotal?this._detailsPane():c.binsTotal=c.bins;this.c.viewTotal&&!this.c.cascadePanes&&(c.arrayFilter=c.arrayTotals)
    for(var e=function(k){if(k&&(void 0!==c.bins[k.filter]&&0!==c.bins[k.filter]&&d.c.cascadePanes||!d.c.cascadePanes||d.s.clearing)){var p=d.addRow(k.display,k.filter,d.c.viewTotal?(void 0===c.bins[k.filter]?0:c.bins[k.filter]):c.bins[k.filter],d.c.viewTotal?String(c.binsTotal[k.filter]):c.bins[k.filter],k.sort,k.type),m=b.findIndex(function(x){return x.filter===k.filter});-1!==m&&(p.select(),b.splice(m,1))}},d=this,f=0,g=c.arrayFilter;f<g.length;f++)e(g[f])}if(void 0!==a.searchPanes&&void 0!==a.searchPanes.options||
...
b.rows().data().toArray().length)c=!1;else if(this.c.viewTotal){b=0;for(f=this.s.panes;b<f.length;b++)if(k=f[b],void 0!==k.s.dtPane){g=k.s.dtPane.rows({ selected:!0 }).data().toArray().length;if(0===g)for(var p=0,m=this.s.selectionList;p<m.length;p++){var x=m[p];x.index===k.s.index&&x.rows.length > 0&&(g=x.rows.length)}0<g&&-1===e?e=k.s.index:0<g&&(e=null)}0===d&&(e=null)}f=void 0;b=[];if(this.regenerating)for(f=-1,1===b.length&&null!==d&&0!==d&&(f=b[0].index),a=0,b=this.s.panes;a<b.length;a++){if(k=
b[a],void 0!==k.s.dtPane){g=!0;k.s.filteringActive=!0;if(-1!==e&&null!==e&&e===k.s.index||!1===c||k.s.index===f)g=!1,k.s.filteringActive=!1;k.updatePane(g?c:g)}}else{g=0;for(p=this.s.panes;g<p.length;g++)if(k=p[g],k.s.selectPresent){this.s.selectionList.push({ index:k.s.index,protect:!1,rows:k.s.dtPane.rows({ selected:!0 }).data().toArray() });break}else k.s.deselect&&(f=k.s.index,m=k.s.dtPane.rows({ selected:!0 }).data().toArray(),m.length > 0&&this.s.selectionList.push({ index:k.s.index,protect:!0,rows:m }))
    if(this.s.selectionList.length > 0)for(g=this.s.selectionList.at(-1).index,p=0,m=this.s.panes;p<m.length;p++)k=m[p],k.s.lastSelect=k.s.index===g;for(k=0;k<this.s.selectionList.length;k++)if(this.s.selectionList[k].index!==f||!0===this.s.selectionList[k].protect){g=!1;for(p=k+1;p<this.s.selectionList.length;p++)this.s.selectionList[p].index===this.s.selectionList[k].index&&(g=!0);g||(b.push(this.s.selectionList[k]),this.s.selectionList[k].protect=!1)}f=-1;1===b.length&&null!==
d&&0!==d&&(f=b[0].index);p=0;for(m=this.s.panes;p<m.length;p++)if(k=m[p],void 0!==k.s.dtPane){g=!0;k.s.filteringActive=!0;if(-1!==e&&null!==e&&e===k.s.index||!1===c||k.s.index===f)g=!1,k.s.filteringActive=!1;k.updatePane(g?c:!1)}if(b.length > 0&&(b.length<this.s.selectionList.length||a))for(this._cascadeRegen(b,d),g=b.at(-1).index,e=0,a=this.s.panes;e<a.length;e++)k=a[e],k.s.lastSelect=k.s.index===g;else if(b.length > 0)for(k=0,a=this.s.panes;k<a.length;k++)if(b=a[k],void 0!==b.s.dtPane){g=!0;b.s.filteringActive=
...
0===c?[]:e.slice(e.length-c);b=0;for(d=this.s.panes;b<d.length;b++)g=d[b],g.s.displayed&&(f=`columns-${e.includes(g.s.index)?c:a}`,g.resize(f))}else for(a=0,c=this.s.panes;a<c.length;a++)g=c[a],g.adjustTopRow();return this};h.prototype._attach=function(){var a=this;this.dom.container.removeClass(this.classes.hide);this.dom.titleRow.removeClass(this.classes.hide);this.dom.titleRow.remove();this.dom.title.appendTo(this.dom.titleRow);this.c.clear&&(this.dom.clearAll.appendTo(this.dom.titleRow),
  this.dom.clearAll.on("click.dtsps",function(){a.clearSelections()}));this.c.collapse&&this._setCollapseListener();this.dom.titleRow.appendTo(this.dom.container);for(var b=0,c=this.s.panes;b<c.length;b++)c[b].dom.container.appendTo(this.dom.panes);this.dom.panes.appendTo(this.dom.container);v(`div.${this.classes.container}`).length === 0&&this.dom.container.prependTo(this.s.dt);return this.dom.container};h.prototype._attachExtras=function(){this.dom.container.removeClass(this.classes.hide);this.dom.titleRow.removeClass(this.classes.hide)
    this.dom.titleRow.remove();this.dom.title.appendTo(this.dom.titleRow);this.c.clear&&this.dom.clearAll.appendTo(this.dom.titleRow);this.c.collapse&&(this.dom.showAll.appendTo(this.dom.titleRow),this.dom.collapseAll.appendTo(this.dom.titleRow));this.dom.titleRow.appendTo(this.dom.container);return this.dom.container};h.prototype._attachMessage=function(){try{var a=this.s.dt.i18n("searchPanes.emptyPanes",this.c.i18n.emptyPanes)}catch(error){a=null}if(null===a)this.dom.container.addClass(this.classes.hide),
...
e[c];d.s.displayed&&(d.dom.collapseButton.hasClass(d.classes.rotated)?(this.dom.showAll.removeClass(this.classes.disabledButton).removeAttr("disabled"),b=!1):(this.dom.collapseAll.removeClass(this.classes.disabledButton).removeAttr("disabled"),a=!1))}a&&this.dom.collapseAll.addClass(this.classes.disabledButton).attr("disabled","true");b&&this.dom.showAll.addClass(this.classes.disabledButton).attr("disabled","true")};h.prototype._collapseAll=function(){for(var a=0,b=this.s.panes;a<b.length;a++)b[a].collapse()}
  h.prototype._getState=function(){var a=this.s.dt.state.loaded();a&&a.searchPanes&&void 0!==a.searchPanes.selectionList&&(this.s.selectionList=a.searchPanes.selectionList)};h.prototype._makeCascadeSelections=function(a){for(var b=0;b<a.length;b++)for(var c=function(f){if(f.s.index===a[b].index&&void 0!==f.s.dtPane){b===a.length-1&&(f.s.lastCascade=!0);f.s.dtPane.rows({ selected:!0 }).data().toArray().length > 0&&void 0!==f.s.dtPane&&(f.setClear(!0),f.clearPane(),f.setClear(!1));for(var g=function(m){var x=
...
function(a,b,c){var e=this;a.columns(this.c.columns.length > 0?this.c.columns:void 0).eq(0).each(function(k){e.s.panes.push(new t(b,c,k,e.c.layout,e.dom.panes))});for(var d=a.columns().eq(0).toArray().length,f=this.c.panes.length,g=0;g<f;g++)this.s.panes.push(new t(b,c,d+g,this.c.layout,this.dom.panes,this.c.panes[g]));if(this.c.order.length > 0)for(d=this.c.order.map(function(k,p,m){return e._findPane(k)}),this.dom.panes.empty(),this.s.panes=d,d=0,f=this.s.panes;d<f.length;d++)this.dom.panes.append(f[d].dom.container)
  this.s.dt.settings()[0]._bInitComplete?this._startup(a):this.s.dt.settings()[0].aoInitComplete.push({ fn:function(){e._startup(a)} })};h.prototype._findPane=function(a){for(var b=0,c=this.s.panes;b<c.length;b++){var e=c[b];if(a===e.s.name)return e}};h.prototype._serverTotals=function(){for(var a=!1,b=!1,c=0,e=this.s.panes;c<e.length;c++){var d=e[c];if(d.s.selectPresent){this.s.selectionList.push({ index:d.s.index,protect:!1,rows:d.s.dtPane.rows({ selected:!0 }).data().toArray() });d.s.selectPresent=!1
    a=!0;break}else d.s.deselect&&(b=d.s.dtPane.rows({ selected:!0 }).data().toArray(),b.length > 0&&this.s.selectionList.push({ index:d.s.index,protect:!0,rows:b }),b=a=!0)}if(a){c=[];for(e=0;e<this.s.selectionList.length;e++){d=!1;for(a=e+1;a<this.s.selectionList.length;a++)this.s.selectionList[a].index===this.s.selectionList[e].index&&(d=!0);if(!d){a=!1;for(var f=0,g=this.s.panes;f<g.length;f++)d=g[f],d.s.index===this.s.selectionList[e].index&&d.s.dtPane.rows({ selected:!0 }).data().toArray().length > 0&&(a=
!0);a&&c.push(this.s.selectionList[e])}}this.s.selectionList=c}else this.s.selectionList=[];c=-1;if(b&&1===this.s.selectionList.length)for(b=0,e=this.s.panes;b<e.length;b++)d=e[b],d.s.lastSelect=!1,d.s.deselect=!1,void 0!==d.s.dtPane&&d.s.dtPane.rows({ selected:!0 }).data().toArray().length > 0&&(c=d.s.index);else if(this.s.selectionList.length > 0)for(b=this.s.selectionList.at(-1).index,e=0,a=this.s.panes;e<a.length;e++)d=a[e],d.s.lastSelect=d.s.index===b,d.s.deselect=!1;else if(this.s.selectionList.length === 0)for(b=0,e=this.s.panes;b<e.length;b++)d=e[b],d.s.lastSelect=!1,d.s.deselect=!1;this.dom.panes.empty();b=0;for(e=this.s.panes;b<e.length;b++)d=e[b],d.s.lastSelect?d._setListeners():d.rebuildPane(void 0,this.s.dt.page.info().serverSide?this.s.serverData:void 0,d.s.index===c?!0:null,!0),this.dom.panes.append(d.dom.container),void 0!==d.s.dtPane&&(v(d.s.dtPane.table().node()).parent()[0].scrollTop=d.s.scrollTop,v.fn.dataTable.select.init(d.s.dtPane));this._updateSelection()}
...
{});void 0===m.searchPanes_null[y]&&(m.searchPanes_null[y]={});if(void 0!==z.s.dtPane){z=z.s.dtPane.rows({ selected:!0 }).data().toArray();for(var w=0;w<z.length;w++)m.searchPanes[y][w]=z[w].filter,null===m.searchPanes[y][w]&&(m.searchPanes_null[y][w]=!0),k++}}b.c.viewTotal&&b._prepViewTotal(k);0<k&&(k===b.s.filterCount?m.start=b.s.page*b.s.dt.page.len():(m.start=0,b.s.page=0),b.s.dt.page(b.s.page),b.s.filterCount=k)});else a.on("preXhr.dt",function(k,p,m){k=0;for(p=b.s.panes;k<p.length;k++)p[k].clearData()})
  this.s.dt.on("xhr",function(k,p,m,x){if(p.nTable===b.s.dt.table().node()){var z=!1;if(!b.s.dt.page.info().serverSide)b.s.dt.one("preDraw",function(){if(!z){var y=b.s.dt.page();z=!0;b.s.updating=!0;b.dom.panes.empty();for(var w=0,u=b.s.panes;w<u.length;w++){var B=u[w];B.clearData();B.rebuildPane(void 0===b.s.selectionList.at(-1)?!1:B.s.index===b.s.selectionList.at(-1).index,void 0,void 0,!0);b.dom.panes.append(B.dom.container)}b.s.dt.page.info().serverSide||
b.s.dt.draw();b.s.updating=!1;b.c.cascadePanes||b.c.viewTotal?b.redrawPanes(b.c.cascadePanes):b._updateSelection();b._checkMessage();b.s.dt.one("draw",function(){b.s.updating=!0;b.s.dt.page(y).draw(!1);b.s.updating=!1})}})}});c=0;for(e=this.s.panes;c<e.length;c++)if(g=e[c],void 0!==g&&void 0!==g.s.dtPane&&(void 0!==g.s.colOpts.preSelect&&g.s.colOpts.preSelect.length > 0||null!==g.customPaneSettings&&void 0!==g.customPaneSettings.preSelect&&g.customPaneSettings.preSelect.length > 0)){d=g.s.dtPane.rows().data().toArray().length
    for(f=0;f<d;f++)(g.s.colOpts.preSelect.includes(g.s.dtPane.cell(f,0).data())||null!==g.customPaneSettings&&void 0!==g.customPaneSettings.preSelect&&g.customPaneSettings.preSelect.includes(g.s.dtPane.cell(f,0).data()))&&g.s.dtPane.row(f).select();g.updateTable()}if(void 0!==this.s.selectionList&&this.s.selectionList.length > 0)for(c=this.s.selectionList.at(-1).index,e=0,d=this.s.panes;e<d.length;e++)g=d[e],g.s.lastSelect=g.s.index===c;this.s.selectionList.length > 0&&this.c.cascadePanes&&
...
0,b=this.s.panes;a<b.length;a++){var c=b[a];void 0!==c.s.dtPane&&this.s.selectionList.push({ index:c.s.index,protect:!1,rows:c.s.dtPane.rows({ selected:!0 }).data().toArray() })}};h.version="1.4.0";h.classes={ clear:"dtsp-clear",clearAll:"dtsp-clearAll",collapseAll:"dtsp-collapseAll",container:"dtsp-searchPanes",disabledButton:"dtsp-disabledButton",emptyMessage:"dtsp-emptyMessage",hide:"dtsp-hidden",panes:"dtsp-panesContainer",search:"dtsp-search",showAll:"dtsp-showAll",title:"dtsp-title",titleRow:"dtsp-titleRow" }
  ...
  return h}();(function(h){"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(a){return h(a,globalThis,document)}):("object"===typeof exports?module.exports=function(a,b){a||(a=globalThis);b&&b.fn.dataTable||(b=require("datatables.net")(a,b).$);return h(b,a,a.document)}:h(globalThis.jQuery,globalThis,document))})(function(h,a,b){function c(d,f,g){void 0===f&&(f=null);void 0===g&&(g=!1);d=new e.Api(d);f=f?f:d.init().searchPanes||e.defaults.searchPanes;return(new F(d,f,g)).getNode()}n(h)
  q(h);var e=h.fn.dataTable;h.fn.dataTable.SearchPanes=F;h.fn.DataTable.SearchPanes=F;h.fn.dataTable.SearchPane=t;h.fn.DataTable.SearchPane=t;a=h.fn.dataTable.Api.register;a("searchPanes()",function(){return this});a("searchPanes.clearSelections()",function(){return this.iterator("table",function(d){d._searchPanes&&d._searchPanes.clearSelections()})});a("searchPanes.rebuildPane()",function(d,f){return this.iterator("table",function(g){g._searchPanes&&g._searchPanes.rebuild(d,f)})});a("searchPanes.resizePanes()",
    ...
    init:function(d,f,g){var k=new h.fn.dataTable.SearchPanes(d,h.extend({ filterChanged:function(m){d.button(f).text(d.i18n("searchPanes.collapse",void 0===d.context[0].oLanguage.searchPanes?d.context[0]._searchPanes.c.i18n.collapse:d.context[0].oLanguage.searchPanes.collapse,m))} },g.config)),p=d.i18n("searchPanes.collapse",k.c.i18n.collapse,0);d.button(f).text(p);g._panes=k},text:"Search Panes" };h(b).on("preInit.dt.dtsp",function(d,f,g){"dt"===d.namespace&&(f.oInit.searchPanes||e.defaults.searchPanes)&&
