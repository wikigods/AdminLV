...
})(globalThis, function(__WEBPACK_EXTERNAL_MODULE__1145__) {
 ...
 */
      ...
      var isSupportTouch = 'ontouchstart' in globalThis || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0 // [workaround] IE doesn't have input events for contentEditable
...
*/
      ...
      function getNextTextNode(actual) {
        if (!actual.nextSibling) return
        if (actual.parent !== actual.nextSibling.parent) return
        return isText(actual.nextSibling) ? actual.nextSibling : getNextTextNode(actual.nextSibling)
      }
      /**
 ...
 */
      ...
      function fromOffsetPath(ancestor, offsets) {
        ...
        for (var i = 0, len = offsets.length; i < len; i++) {
          current = current.childNodes.length <= offsets[i] ? current.childNodes.at(-1) : current.childNodes[offsets[i]]
        }
 ...
 */
      ...
      function html($node, isNewlineOnBlock) {
        ...
        if (isNewlineOnBlock) {
          ...
          markup = markup.replaceAll(regexTag, function (match, endSlash, name) {
 ...
 */
      ...
      function textRangeToPoint(textRange, isStart) {
        ...
        if (offset !== 0 && dom.isText(childNodes[offset - 1])) {
          ...
          var textCount = pointTester.text.replaceAll(/[\r\n]/g, '').length
   ...
   */
     ...
     */
          ...
          value: function collapse(isCollapseToStart) {
            return isCollapseToStart ? new WrappedRange(this.sc, this.so, this.sc, this.so) : new WrappedRange(this.ec, this.eo, this.ec, this.eo)
          }
          /**
     * splitText on range
     */
       ...
       */
            ...
            if (dom.isInline(rng.sc)) {
              ...
              if (!dom.isInline(topAncestor)) {
                topAncestor = ancestors.at(-2) || rng.sc.childNodes[rng.so]
              }
            } else {
     ...
     */
          ...
          value: function getWordsMatchRange(regex) {
            ...
            return result && result[0].length === text.length ? rng : null
          }
          /**
    ...
    */
     ...
     */
          ...
          value: function current(rng) {
            var $cont = external_jQuery_default()(dom.isElement(rng.sc) ? rng.sc : rng.sc.parentNode)
                ...
                case TableResultAction.resultAction.SumSpanCount: {
                  {
                    if (position === 'top') {
                      ...
                      var isTopFromRowSpan = (baseCellTr ? currentCell.baseCell.closest('tr').rowIndex : 0) <= currentTr[0].rowIndex
 ...
 */
     ...
     */
          ...
          this.removeMedia = this.wrapCommand(function () {
            ...
            if ($target.closest('figure').length > 0) {
        ...
        Editor_createClass(Editor, [{
          ...
          value: function initialize() {
            ...
            this.$editable.on('keydown', function (event) {
              ...
              if (_this2.options.recordEveryKeystroke && _this2.hasKeyShortCut === false) {
          ...
          value: function isLimited(pad, event) {
            ...
            if (event !== undefined && (key.isMove(event.keyCode) || key.isNavigation(event.keyCode) || event.ctrlKey || event.metaKey || lists.contains([key.code.BACKSPACE, key.code.DELETE], event.keyCode))) {
              return false
            }

            if (this.options.maxTextLength > 0 && this.$editable.text().length + pad > this.options.maxTextLength) {
              return true
            }
    ...
    */
     ...
     */
          ...
          value: function getLinkInfo() {
            ...
            var linkInfo = {
              range: rng,
              text: rng.toString(),
              url: $anchor.length > 0 ? $anchor.attr('href') : ''
            } // When anchor exists,
     ...
     */
          ...
          this.context.invoke('editor.isLimited', clipboardData.getData('Text').length)) {
              ...
              // for IE
              var text = globalThis.clipboardData.getData('text')
     ...
     */
          ...
          value: function attachDragAndDropEvent() {
            ...
            this.documentEventHandlers.onDragenter = function (e) {
              ...
              if (!isCodeview && collection.length === 0 && hasEditorSize) {
            ...
            this.documentEventHandlers.onDragleave = function (e) {
              ...
              if (collection.length === 0 || e.target.nodeName === 'BODY') {
 ...
 */
      ...
      var CodeView = /*#__PURE__*/function () {
        function CodeView(context) {
          ...
          this.options = context.options
          this.CodeMirrorConstructor = globalThis.CodeMirror
          ...
          value: function purify(value) {
            if (this.options.codeviewFilter) {
              ...
              if (this.options.codeviewIframeFilter) {
                ...
                value = value.replaceAll(/(<iframe.*?>.*?(?:<\/iframe>)?)/gi, function (tag) {
                  ...
                  try {
                    for (_iterator.s(); !(_step = _iterator.n()).done;) {
                      ...
                      if (new RegExp(`src="(https?:)?\/\/${  src.replaceAll(/[-\/\\^$*+?.()|[\]{}]/g, String.raw`\$&`)  }\/(.+)"`).test(tag)) {
                        return tag
                      }
                    }
                  } catch (error) {
     ...
     */
      ...
      var Fullscreen = /*#__PURE__*/function () {
        function Fullscreen(context) {
          ...
          this.$editable = context.layoutInfo.editable
          this.$codable = context.layoutInfo.codable
          this.$window = external_jQuery_default()(globalThis)
            ...
            this.context.memo('button.fontname', function () {
              ...
              if (_this2.options.addDefaultFonts) {
                ...
                external_jQuery_default().each(styleInfo['font-family'].split(','), function (idx, fontname) {
                  fontname = fontname.trim().replaceAll(/['"]+/g, '')

                  if (_this2.isFontDeservedToAdd(fontname) && _this2.options.fontNames.indexOf(fontname) === -1) {
          ...
          value: function updateCurrentStyle($container) {
            ...
            if (styleInfo['font-family']) {
              var fontNames = styleInfo['font-family'].split(',').map(function (name) {
                return name.replaceAll(/[\'\"]/g, '').replace(/\s+$/, '').replace(/^\s+/, '')
              })
          ...
          value: function showLinkDialog(linkInfo) {
            ...
            return external_jQuery_default().Deferred(function (deferred) {
              ...
              _this.ui.onDialogShown(_this.$dialog, function () {
                ...
                var isNewWindowChecked = linkInfo.isNewWindow === undefined ? _this.context.options.linkTargetBlank : linkInfo.isNewWindow
        ...
        VideoDialog_createClass(VideoDialog, [{
          ...
          value: function createVideoNode(url) {
            ...
            if (ytMatch && ytMatch[1].length === 11) {
              ...
              if (ytMatch[2] !== undefined) {
                var ytMatchForStart = ytMatch[2].match(ytRegExpForStart)

                if (ytMatchForStart) {
                  for (var n = [3600, 60, 1], i = 0, r = n.length; i < r; i++) {
                    start += ytMatchForStart[i + 1] === undefined ? 0 : n[i] * parseInt(ytMatchForStart[i + 1], 10)
                  }
                }
              }
            ...
            } else if (gdMatch && gdMatch[0].length > 0) {
            ...
            } else if (youkuMatch && youkuMatch[1].length > 0) {
            ...
            } else if (peerTubeMatch && peerTubeMatch[0].length > 0) {
              var begin = 0
            ...
            } else if (qqMatch && qqMatch[1].length > 0 || qqMatch2 && qqMatch2[2].length > 0) {
              var vid = qqMatch && qqMatch[1].length > 0 ? qqMatch[1] : qqMatch2[2]
            ...
            } else if (fbMatch && fbMatch[0].length > 0) {
        ...
        HintPopover_createClass(HintPopover, [{
          ...
          value: function handleKeyup(e) {
            ...
            if (!lists.contains([key.code.ENTER, key.code.UP, key.code.DOWN], e.keyCode)) {
              ...
              if (this.hints.length > 0 && keyword) {
                this.$content.empty()
...
;// CONCATENATED MODULE: ./src/js/settings.js
          ...
          value: function render($parent) {
            ...
            if (this.children) {
              ...
              this.children.forEach(function (child) {
                child.render($container.length > 0 ? $container : $node)
              })
            }
      ...
      function summernote_bs4_typeof(obj) { "@babel/helpers - typeof"; summernote_bs4_typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function _typeof(obj) { return typeof obj } : function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj }; return summernote_bs4_typeof(obj) }
      ...
      var popover = renderer.create(['<div class="note-popover popover in">', '<div class="arrow"></div>', '<div class="popover-content note-children-container"></div>', '</div>'].join(''), function ($node, options) {
        var direction = options.direction === undefined ? 'bottom' : options.direction
