...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ?
    ...
    (typeof define === 'function' && define.amd ?
      define(factory) :
      (global = global || globalThis, global.Stepper = factory()))
  ...
  var WinEvent = function WinEvent(inType, params) {
    return new globalThis.Event(inType, params)
  }

  var createCustomEvent = function createCustomEvent(eventName, params) {
    var cEvent = new globalThis.CustomEvent(eventName, params)
    return cEvent
  }
  ...
  function polyfill() {
    if (!globalThis.Element.prototype.matches) {
      matches = globalThis.Element.prototype.msMatchesSelector || globalThis.Element.prototype.webkitMatchesSelector
    }

    if (!globalThis.Element.prototype.closest) {
    ...
    if (!globalThis.Event || typeof globalThis.Event !== 'function') {
    ...
    if (typeof globalThis.CustomEvent !== 'function') {
      var originPreventDefault = globalThis.Event.prototype.preventDefault
  ...
  var getTransitionDurationFromElement = function getTransitionDurationFromElement(element) {
    ...
    var transitionDuration = globalThis.getComputedStyle(element).transitionDuration
  ...
  function () {
    function Stepper(element, _options) {
      ...
      this._steps = Array.prototype.slice.call(this._element.querySelectorAll(this.options.selectors.steps))
    ...
    _proto.next = function next() {
      ...
      var nextStep = Math.min(this._currentIndex + 1, this._steps.length - 1)
    ...
    _proto.previous = function previous() {
      ...
      var previousStep = Math.max(this._currentIndex - 1, 0)
