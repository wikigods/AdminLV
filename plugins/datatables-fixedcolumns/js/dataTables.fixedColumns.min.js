...
u.css(this._clearCellCSS("right")).removeClass(this.classes.fixedRight)}else r++;c&&(this.s.rtl?(this.dom.leftTopBlocker.outerHeight(h),a.append(this.dom.leftTopBlocker)):(this.dom.rightTopBlocker.outerHeight(h),a.append(this.dom.rightTopBlocker)));l&&(this.s.rtl?(this.dom.leftBottomBlocker.outerHeight(e),a.append(this.dom.leftBottomBlocker)):(this.dom.rightBottomBlocker.outerHeight(e),a.append(this.dom.rightBottomBlocker)))};f.prototype._getCellCSS=function(a,c,h){return"left"===h?
  (this.s.rtl?
    { position:"sticky",
      right:`${c+(a?this.s.barWidth:0)}px` }:
    { left:`${c}px`,position:"sticky" }):
  (this.s.rtl?{ left:`${c}px`,position:"sticky" }:{ position:"sticky",right:`${c+(a?this.s.barWidth:0)}px` })};f.prototype._clearCellCSS=function(a){return"left"===a?(this.s.rtl?{ position:"",right:"" }:{ left:"",position:"" }):(this.s.rtl?{ left:"",position:"" }:{ position:"",right:"" })};f.prototype._setKeyTableListener=function(){var a=this;this.s.dt.on("key-focus",function(c,h,l){c=b(l.node()).offset();h=b(b(a.s.dt.table().node()).closest("div.dataTables_scrollBody"))
  ...
  define(["jquery","datatables.net"],
    function(a){return f(a,globalThis,document)}):
  ("object"===typeof exports?module.exports=function(a,c){a||(a=globalThis);c&&c.fn.dataTable||(c=require("datatables.net")(a,c).$);return f(c,a,a.document)}:f(globalThis.jQuery,globalThis,document))})(function(f,a,c){function h(e,d){void 0===d&&(d=null);e=new l.Api(e);d=d?d:e.init().fixedColumns||l.defaults.fixedColumns;return new w(e,d)}b=f;v=b.fn.dataTable;var l=f.fn.dataTable;f.fn.dataTable.FixedColumns=w;f.fn.DataTable.FixedColumns=w;a=f.fn.dataTable.Api.register;a("fixedColumns()",
  function(){return this});a("fixedColumns().left()",function(e){var d=this.context[0];return void 0===e?d._fixedColumns.left():(d._fixedColumns.left(e),this)});a("fixedColumns().right()",function(e){var d=this.context[0];return void 0===e?d._fixedColumns.right():(d._fixedColumns.right(e),this)});f.fn.dataTable.ext.buttons.fixedColumns={ action:function(e,d,k,q){f(k).attr("active")?
  (f(k).removeAttr("active").removeClass("active"),d.fixedColumns().left(0),d.fixedColumns().right(0)):
  (f(k).attr("active",
