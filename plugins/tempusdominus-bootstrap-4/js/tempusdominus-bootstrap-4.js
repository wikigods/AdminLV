...
if (typeof jQuery === 'undefined') {
  throw new TypeError('Tempus Dominus Bootstrap4\'s requires jQuery. jQuery must be included before Tempus Dominus Bootstrap4\'s JavaScript.')
}
...
if (typeof moment === 'undefined') {
  throw new TypeError('Tempus Dominus Bootstrap4\'s requires moment.js. Moment.js must be included before Tempus Dominus Bootstrap4\'s JavaScript.')
}
...
+function () {
     ...
     */
      ...
      _proto._int = function _int() {
        ...
        if (this._element.is('input')) {
          ...
          this.input = targetInput === 'nearest' ? this._element.find('input') : $(targetInput)
        }
      ...
      _proto._keydown = function _keydown(e) {
        ...
        for (index in this._options.keyBinds) {
          if (this._options.keyBinds.hasOwnProperty(index) && typeof this._options.keyBinds[index] === 'function') {
            ...
            if (keyBindKeys.length === pressedKeys.length && KeyMap[currentKey] === keyBindKeys.at(-1)) {
      ...
      // (for example: options.enabledDates['2014-02-27'] === true)
        ...
        return Object.keys(givenDatesIndexed).length > 0 ? givenDatesIndexed : false
      }
      ...
      // (for example: options.enabledHours['2014-02-27'] === true)
        ...
        return Object.keys(givenHoursIndexed).length > 0 ? givenHoursIndexed : false
      }

      _proto._initFormatting = function _initFormatting() {
        var format = this._options.format || 'L LT',
          self = this
        this.actualFormat = format.replaceAll(/(\[[^\[]*])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, function (formatInput) {
        ...
        this.parseFormats = this._options.extraFormats ? [...this._options.extraFormats] : []

        if (this.parseFormats.indexOf(format) < 0 && this.parseFormats.indexOf(this.actualFormat) < 0) {
          this.parseFormats.push(this.actualFormat)
        }

        this.use24Hours = this.actualFormat.toLowerCase().indexOf('a') < 1 && this.actualFormat.replaceAll(/\[.*?]/g, '').indexOf('h') < 1
      ...
      _proto.date = function date(newDate, index) {
        ...
        if (arguments.length === 0) {
          ...
          return this._options.allowMultidate ? this._dates.join(this._options.multidateSeparator) : this._dates[index].clone()
        }
      ...
      _proto.extraFormats = function extraFormats(formats) {
        ...
        if (formats !== false && !(Array.isArray(formats))) {
      ...
      _proto.daysOfWeekDisabled = function daysOfWeekDisabled(_daysOfWeekDisabled) {
        ...
        if (!(Array.isArray(_daysOfWeekDisabled))) {
      ...
      _proto.maxDate = function maxDate(_maxDate) {
        ...
        if (typeof _maxDate === 'string' && (_maxDate === 'now' || _maxDate === 'moment')) {
      ...
      _proto.minDate = function minDate(_minDate) {
        ...
        if (typeof _minDate === 'string' && (_minDate === 'now' || _minDate === 'moment')) {
      ...
      _proto.defaultDate = function defaultDate(_defaultDate) {
        ...
        if (typeof _defaultDate === 'string') {
          _defaultDate = _defaultDate === 'now' || _defaultDate === 'moment' ? this.getMoment() : this.getMoment(_defaultDate)
        }
      ...
      _proto.disabledTimeIntervals = function disabledTimeIntervals(_disabledTimeIntervals) {
        ...
        if (!(Array.isArray(_disabledTimeIntervals))) {
    ...
    var TempusDominusBootstrap4 = /*#__PURE__*/function (_DateTimePicker) {
      ...
      _proto2._init = function _init() {
        if (this._element.hasClass('input-group')) {
          ...
          this.component = datepickerButton.length === 0 ? this._element.find('[data-toggle="datetimepicker"]') : datepickerButton
        }
      }

      _proto2._iconTag = function _iconTag(iconName) {
        return typeof feather !== 'undefined' && this._useFeatherIcons() && feather.icons[iconName] ? $('<span>').html(feather.icons[iconName].toSvg()) : $('<span>').addClass(iconName)
      }
      ...
      _proto2._place = function _place(e) {
        var self = e && e.data && e.data.picker || this,
          ...
          parent
        var position = (self.component && self.component.length > 0 ? self.component : self._element).position(),
          offset = (self.component && self.component.length > 0 ? self.component : self._element).offset()
        ...
        //noinspection JSValidateTypes
          vertical = offset.top + self.widget.height() * 1.5 >= $(globalThis).height() + $(globalThis).scrollTop() && self.widget.height() + self._element.outerHeight() < offset.top ? 'top' : 'bottom'
        } // Left and right logic


        if (horizontal === 'auto') {
          horizontal = parent.width() < offset.left + self.widget.outerWidth() / 2 && offset.left + self.widget.outerWidth() > $(globalThis).width() ? 'right' : 'left'
        }
      ...
      _proto2._updateDecades = function _updateDecades() {
        ...
        html += startDecade.year() - 10 < 0 ? '<span>&nbsp;</span>' : `<span data-action="selectDecade" class="decade old" data-selection="${  startDecade.year() + 6  }">${  startDecade.year() - 10  }</span>`
      ...
      _proto2._fillDate = function _fillDate() {
        ...
        //always display 42 days (should show 6 weeks)
          ...
          if (this._options.allowMultidate) {
            ...
            if (index !== -1 && currentDate.isSame(this._datesFormatted[index], 'd') && !this.unset) {
              clsName += ' active'
            }
          } else {
          ...
          case 'togglePicker': {
            {
              ...
              if (expanded && expanded.length > 0) {
                ...
                iconTest = this._useFeatherIcons() ? $link.hasClass(this._options.icons.date) : $span.hasClass(this._options.icons.date)
      ...
      _proto2.hide = function hide() {
        ...
        this.widget.hide()
        $(globalThis).off('resize', this._place)
      ...
      _proto2.widgetPositioning = function widgetPositioning(_widgetPositioning) {
        ...
        if (Object.prototype.toString.call(_widgetPositioning) !== '[object Object]') {
  ...
  */
    ...
    $(document).on(DateTimePicker.Event.CLICK_DATA_API, DateTimePicker.Selector.DATA_TOGGLE, function () {
      ...
      if (config._options.debug || globalThis.debug) {
        return
      }
