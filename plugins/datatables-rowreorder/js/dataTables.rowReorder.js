  ...
  $.extend( RowReorder.prototype, {
    ...
    _mouseDown: function ( e, target )
    {
      ...
      this.s.scroll = {
        ...
        dtTop:        scrollWrapper.length > 0 ? scrollWrapper.offset().top : null,
        dtLeft:       scrollWrapper.length > 0 ? scrollWrapper.offset().left : null,
        dtHeight:     scrollWrapper.length > 0 ? scrollWrapper.outerHeight() : null,
        dtWidth:      scrollWrapper.length > 0 ? scrollWrapper.outerWidth() : null
      }
    },
