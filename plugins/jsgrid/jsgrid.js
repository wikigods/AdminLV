...
(function(window, $, undefined) {
  ...
  Grid.prototype = {
    ...
    _createCell: function(item, field) {
      ...
      $result = $.isFunction(field.cellRenderer) ? this.renderTemplate(field.cellRenderer, field, args) : $("<td>").append(this.renderTemplate(field.itemTemplate || fieldValue, field, args))
    ...
    _createPager: function() {
      ...
      $result = $.isFunction(this.pagerRenderer) ?
        $(this.pagerRenderer({
    ...
    _createPagerByFormat: function() {
      ...
      return $.map(pagerParts, $.proxy(function(pagerPart) {
        ...
        switch (pagerPart) {
          case PAGES_PLACEHOLDER: {
            result = this._createPages()
        
            break
          }
          case FIRST_PAGE_PLACEHOLDER: {
            result = this._createPagerNavButton(this.pageFirstText, 1, pageIndex > 1)
        
            break
          }
          case PREV_PAGE_PLACEHOLDER: {
            result = this._createPagerNavButton(this.pagePrevText, pageIndex - 1, pageIndex > 1)
        
            break
          }
          case NEXT_PAGE_PLACEHOLDER: {
            result = this._createPagerNavButton(this.pageNextText, pageIndex + 1, pageIndex < pageCount)
        
            break
          }
          case LAST_PAGE_PLACEHOLDER: {
            result = this._createPagerNavButton(this.pageLastText, pageCount, pageIndex < pageCount)
        
            break
          }
          case PAGE_INDEX_PLACEHOLDER: {
            result = pageIndex
        
            break
          }
          case PAGE_COUNT_PLACEHOLDER: {
            result = pageCount
        
            break
          }
          case ITEM_COUNT_PLACEHOLDER: {
            result = itemCount
    ...
    _refreshHeight: function() {
      ...
      if(height !== "auto") {
        ...
        if(pagerContainer.parents(container).length > 0) {
    ...
    _setCellValidity: function($cell, errors) {
      $cell
                .toggleClass(this.invalidClass, errors.length > 0)
...
(function(jsGrid, $, undefined) {
  ...
  Field.prototype = {
    ...
    _getSortingFunc: function() {
      ...
      throw new Error(`wrong sorter for the field "${  this.name  }"!`)
    }
  }
...
(function(jsGrid, $, undefined) {
  ...
  TextField.prototype = new Field({
    ...
    editTemplate: function(value) {
      if(!this.editing)
        return Reflect.apply(this.itemTemplate, this, arguments)
...
(function(jsGrid, $, undefined) {
  ...
  function SelectField(config) {
    ...
    if(config.valueField && config.items.length > 0) {
