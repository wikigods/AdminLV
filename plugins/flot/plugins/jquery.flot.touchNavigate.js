...
(function($) {
  ...
  function initTouchNavigation(plot, options) {
    ...
    function presetNavigationState(e, gesture, gestureState) {
      ...
      navigationState.navigationConstraint = noAxisTouched(navigationState) ? 'unconstrained' : 'axisConstrained'
    }
  }
  ...
  function recenterPlotOnDoubleTap(plot, e, gestureState, navigationState) {
    ...
    if ((navigationState.currentTouchedAxis === 'x' && navigationState.prevTouchedAxis === 'x') ||
      ...
      event = navigationState.touchedAxis ? new $.Event('re-center', { detail: { axisTouched: navigationState.touchedAxis } }) : new $.Event('re-center', { detail: e })
