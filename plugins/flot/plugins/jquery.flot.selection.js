  ...
  function init(plot) {
    ...
    function onDragStart(e) {
      ...
      if (document.onselectstart !== undefined && savedhandlers.onselectstart == null) {
        savedhandlers.addEventListener('selectstart', document.onselectstart)
        document.addEventListener('selectstart', function () { return false })
      }
      if (document.ondrag !== undefined && savedhandlers.ondrag == null) {
        savedhandlers.addEventListener('drag', document.ondrag)
        document.addEventListener('drag', function () { return false })
      }
    ...
    function onDragEnd(e) {
      ...
      if (document.onselectstart !== undefined) {
        document.addEventListener('selectstart', savedhandlers.onselectstart)
      }

      if (document.ondrag !== undefined) {
        document.addEventListener('drag', savedhandlers.ondrag)
      }
    ...
    function selectionDirection(plot) {
      ...
      return o.selection.mode === 'smart' ? selection.currentMode : o.selection.mode
    }
