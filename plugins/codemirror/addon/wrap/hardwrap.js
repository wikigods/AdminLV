...
(function(mod) {
  ...
  function wrapRange(cm, from, to, options) {
    ...
    if (changes.length > 0) cm.operation(function() {
    ...
    return changes.length > 0 ? { from: changes[0].from, to: CodeMirror.changeEnd(changes.at(-1)) } : null
  }
  ...
  CodeMirror.defineExtension("wrapParagraphsInRange", function(from, to, options) {
    ...
    if (paras.length > 0) cm.operation(function() {
