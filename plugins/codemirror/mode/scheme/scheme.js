          ...
          default: { // default parsing mode
            ...
            if (ch == "\"") {
              ...
              if (stream.eat("|")) {                    // Multi-line comment
                ...
                } else if (/^#o/i.test(stream)) {
                  numTest = isOctalNumber
                } else if (/^#x/i.test(stream)) {
                  numTest = isHexNumber
                } else if (/^#d/i.test(stream)) {
              ...
              returnType = keywords && keywords.propertyIsEnumerable(stream.current()) ? BUILTIN : "variable"
            }
          }
        }
