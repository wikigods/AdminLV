...
})(globalThis, function(__WEBPACK_EXTERNAL_MODULE__0__) {
 ...
 */
   ...
   */
     ...
     */
          ...
          if (!(this.colorpicker.element && this.colorpicker.element.length > 0)) {
   ...
   */
     ...
     */
          ...
          value: function parse(color) {
            ...
            color = color instanceof HSVAColor ? [color.h, color.s, color.v, isNaN(color.a) ? 1 : color.a] : ColorItem.sanitizeString(color)
 ...
 * */
      ...
      _jquery2.default.fn[plugin] = function (option) {
        ...
        var $elements = this.each(function () {
          var $this = (0, _jquery2.default)(this),
            ...
            options = (option === undefined ? 'undefined' : _typeof(option)) === 'object' ? option : {}
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      var root = globalThis.self === undefined ? undefined : globalThis // window
 ...
 */
     ...
     */
          ...
          this.container = this.container === false ? false : (0, _jquery2.default)(this.container)
 ...
 */
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      var _get = function get(object, property, receiver) { if (object === null) object = Function.prototype; var desc = Object.getOwnPropertyDescriptor(object, property); if (desc === undefined) { var parent = Object.getPrototypeOf(object); return parent === null ? undefined : get(parent, property, receiver) } else if ("value" in desc) { return desc.value } else { var getter = desc.get; if (getter === undefined) { return } return getter.call(receiver) } }
   ...
   */
        ...
        _createClass(SliderHandler, [{
          ...
          value: function defaultOnMove(top, left) {
            ...
            var color = ch.hasColor() ? ch.color.getClone() : ch.getFallbackColor()
   ...
   */
     ...
     */
          ...
          value: function createPopover() {
            ...
            /* global bootstrap */
            var useGetInstance = globalThis.bootstrap && globalThis.bootstrap.Popover && globalThis.bootstrap.Popover.getInstance
   ...
   */
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      Color.prototype = {
        ...
        array: function () {
          return this.valpha === 1 ? [...this.color] : this.color.concat(this.valpha)
        },
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      module.exports = function isArrayish(obj) {
        ...
        return Array.isArray(obj) || Array.isArray(obj) ||
		(obj.length >= 0 && typeof obj.splice === 'function')
      }
   ...
   */
     ...
     */
          ...
          get: function get() {
            ...
            if (this.hasColor() && this.color.hasTransparency() && this.color.format.startsWith('hex')) {
   ...
   */
     ...
     */
       ...
       */
          ...
          value: function _supportsAlphaBar() {
            return (this.options.useAlpha || this.colorpicker.colorHandler.hasColor() && this.color.hasTransparency()) && this.options.useAlpha !== false && (!this.options.format || this.options.format && !/^hex([36])?$/i.test(this.options.format))
          }
     ...
     */
          ...
          value: function update() {
            ...
            alphaBg = this.options.horizontal ? `linear-gradient(to right, ${  hexColor  } 0%, transparent 100%)` : `linear-gradient(to bottom, ${  hexColor  } 0%, transparent 100%)`
