(function() {
  ...
  now = function() {
    var ref
    return (ref = typeof performance !== "undefined" && performance !== null ? (typeof performance.now === "function" ? performance.now() : void 0) : void 0) == null ? Date.now() : ref
  }

  requestAnimationFrame = globalThis.requestAnimationFrame || globalThis.mozRequestAnimationFrame || globalThis.webkitRequestAnimationFrame || globalThis.msRequestAnimationFrame

  cancelAnimationFrame = globalThis.cancelAnimationFrame || globalThis.mozCancelAnimationFrame
  ...
  result = function() {
    ...
    return typeof obj[key] === 'function' ? obj[key].apply(obj, args) : obj[key]
  }
  ...
  Evented = (function() {
    ...
    Evented.prototype.off = function(event, handler) {
      var i, ref, results
      if (((ref = this.bindings) == null ? void 0 : ref[event]) == null) {
        return
      }
      if (handler == null) {
    ...
    Evented.prototype.trigger = function() {
      ...
      if ((ref = this.bindings) == null ? void 0 : ref[event]) {
        i = 0
        results = []
        while (i < this.bindings[event].length) {
          ref1 = this.bindings[event][i], handler = ref1.handler, ctx = ref1.ctx, once = ref1.once
          handler.apply(ctx == null ? this : ctx, args)
          if (once) {
            results.push(this.bindings[event].splice(i, 1))
          } else {
            results.push(i++)
  ...
  Pace = globalThis.Pace || {}

  globalThis.Pace = Pace

  extend(Pace, Evented.prototype)

  options = Pace.options = extend({}, defaultOptions, globalThis.paceOptions, getFromDOM())
  ...
  NoTargetError = (function(superClass) {
    ...
    function NoTargetError() {
      return Reflect.apply(NoTargetError.__super__.constructor, this, arguments)
    }
  ...
  _XMLHttpRequest = globalThis.XMLHttpRequest

  _XDomainRequest = globalThis.XDomainRequest
  ...
  shouldTrack = function(method) {
    ...
    if (ignoreStack.length === 0 && options.ajax) {
  ...
  RequestIntercept = (function(superClass) {
    ...
    function RequestIntercept() {
      var monitorXHR
      Reflect.apply(RequestIntercept.__super__.constructor, this, arguments)
      ...
      globalThis.XMLHttpRequest = function(flags) {
        var req
      ...
      try {
        extendNative(globalThis.XMLHttpRequest, _XMLHttpRequest)
      } catch (error) {}
      if (_XDomainRequest != null) {
        globalThis.XDomainRequest = function() {
          var req
        ...
        try {
          extendNative(globalThis.XDomainRequest, _XDomainRequest)
        } catch (error) {}
      }
      if ((_WebSocket != null) && options.ajax.trackWebSockets) {
        globalThis.WebSocket = (function(_this) {
          return function(url, protocols) {
            var req
            req = protocols == null ? new _WebSocket(url) : new _WebSocket(url, protocols)
        ...
        try {
          extendNative(globalThis.WebSocket, _WebSocket)
        } catch (error) {}
      }
    }
  ...
  getIntercept().on('request', function(arg) {
    ...
    if (!Pace.running && (options.restartOnRequestAfter !== false || shouldTrack(type) === 'force')) {
      ...
      return setTimeout(function() {
        ...
        stillActive = type === 'socket' ? request.readyState < 2 : (0 < (ref1 = request.readyState) && ref1 < 4)
        if (stillActive) {
          Pace.restart()
          ref2 = Pace.sources
          results = []
  ...
  AjaxMonitor = (function() {
    ...
    AjaxMonitor.prototype.watch = function(arg) {
      ...
      tracker = type === 'socket' ? new SocketRequestTracker(request) : new XHRRequestTracker(request)
  ...
  XHRRequestTracker = (function() {
    function XHRRequestTracker(request) {
      ...
      this.progress = 0
      if (globalThis.ProgressEvent == null) {
        _onreadystatechange = request.onreadystatechange
        request.addEventListener('readystatechange', (function(_this) {
          return function() {
            var ref2
            ...
            return typeof _onreadystatechange === "function" ? Reflect.apply(_onreadystatechange, null, arguments) : void 0
          }
        })(this))
      } else {
        size = null
  ...
  DocumentMonitor = (function() {
    ...
    function DocumentMonitor() {
      ...
      this.progress = (ref1 = this.states[document.readyState]) == null ? 100 : ref1
  ...
  if (globalThis.history.pushState != null) {
    _pushState = globalThis.history.pushState
    globalThis.history.pushState = function() {
      handlePushState()
      return _pushState.apply(globalThis.history, arguments)
    }
  }

  if (globalThis.history.replaceState != null) {
    _replaceState = globalThis.history.replaceState
    globalThis.history.replaceState = function() {
      handlePushState()
      return _replaceState.apply(globalThis.history, arguments)
    }
  }
  ...
  Pace.go = function() {
    ...
    return animation = runAnimation(function(frameTime, enqueueNextFrame) {
      ...
      for (i = l = 0, len1 = sources.length; l < len1; i = ++l) {
        ...
        elements = (ref1 = source.elements) == null ? [source] : ref1
        for (j = m = 0, len2 = elements.length; m < len2; j = ++m) {
          element = elements[j]
          scaler = scalerList[j] == null ? scalerList[j] = new Scaler(element) : scalerList[j]
          done &= scaler.done
          if (scaler.done) {
            continue
          }
